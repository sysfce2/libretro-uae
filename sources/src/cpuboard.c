...
int cpuboard_memorytype(struct uae_prefs *p) { return 0; }
int cpuboard_maxmemory(struct uae_prefs *p) { return 0; }
void cpuboard_setboard(struct uae_prefs *p, int type, int subtype) {}
bool cpuboard_is_ppcboard_irq(void) { return false; }
void cpuboard_rethink(void) {}
bool cpuboard_fc_check(uaecptr addr, uae_u32 *v, int size, bool write) { return false; }
uaecptr cpuboard_get_reset_pc(uaecptr *stack) { return 0; }
bool cpuboard_io_special(int addr, uae_u32 *val, int size, bool write) { return false; }
bool cpuboard_autoconfig_init(struct autoconfig_info *aci) { return false; }
bool cpuboard_32bit(struct uae_prefs *p) { return false; }

void cyberstorm_scsi_ram_put(uaecptr addr, uae_u32 v) {}
uae_u32 cyberstorm_scsi_ram_get(uaecptr addr) { return 0; }
uae_u8 *REGPARAM2 cyberstorm_scsi_ram_xlate(uaecptr addr) { return 0; }
int REGPARAM2 cyberstorm_scsi_ram_check(uaecptr a, uae_u32 b) { return 0; }
